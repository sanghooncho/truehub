    ...
    >
      ...
      <div className="space-y-6 p-5">
        <section>
          ...
          <h1 className="mb-4 text-2xl leading-tight font-bold text-slate-900">{campaign.title}</h1>
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">{campaign.advertiserName}</span>
            <span className="text-secondary text-2xl font-bold tabular-nums">
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-slate-900">캠페인 소개</h2>
        ...
        {(campaign.appLinkIos || campaign.appLinkAndroid) && (
          <>
            <div className="h-px bg-slate-100" />
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-900">앱 다운로드</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-slate-900">참여 방법</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-slate-900">답변할 질문</h2>
          <div className="space-y-3">
      ...
      <div className="pb-safe fixed right-0 bottom-16 left-0 border-t border-slate-100 bg-white p-4">
        <div className="mx-auto max-w-md">
          {campaign.isParticipated ? (
            ...
            <Link href={`/tester/campaigns/${campaignId}/submit`}>
              <motion.button
                whileTap={{ scale: 0.96 }}
