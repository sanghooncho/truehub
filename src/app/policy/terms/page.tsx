      ...
      <div className="mx-auto max-w-3xl p-5">
        <div className="prose prose-slate max-w-none text-sm">
          ...
          <ol className="list-decimal pl-5 text-slate-700">
            ...
            <li><strong>"광고주"</strong>란 서비스에 가입하여 캠페인을 등록하고 운영하는 사업자 회원을 의미합니다.</li>
            <li><strong>"캠페인"</strong>이란 광고주가 등록한 앱 체험 및 피드백 수집 프로그램을 의미합니다.</li>
            <li><strong>"리워드"</strong>란 캠페인 참여가 승인된 테스터에게 지급되는 보상을 의미합니다.</li>
            <li><strong>"크레딧"</strong>이란 광고주가 캠페인 운영을 위해 충전하는 선불 포인트를 의미합니다.</li>
          ...
          <ol className="list-decimal pl-5 text-slate-700">
            <li><strong>테스터</strong>: 카카오, 네이버, 구글 소셜 로그인을 통해 가입합니다.</li>
            <li><strong>광고주</strong>: 이메일과 비밀번호로 가입하며, 사업자 정보를 등록합니다.</li>
            <li>이용자는 본인의 정보를 정확하게 제공해야 하며, 허위 정보 제공 시 서비스 이용이 제한될 수 있습니다.</li>
            <li>만 14세 미만의 아동은 서비스에 가입할 수 없습니다.</li>
          </ol>

          <h2 className="mt-6 text-base font-bold text-slate-900">제5조 (캠페인 참여 - 테스터)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제6조 (크레딧 및 캠페인 운영 - 광고주)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
            <li>광고주는 캠페인 운영을 위해 크레딧을 충전해야 합니다.</li>
            <li>최소 충전 금액은 50,000원이며, 50,000원/100,000원/300,000원 단위로 충전할 수 있습니다.</li>
            <li>크레딧은 참여가 승인될 때 차감됩니다.</li>
            <li>크레딧 잔액이 1회 참여 비용보다 적으면 캠페인이 자동으로 일시정지됩니다.</li>
            <li>충전된 크레딧의 유효기간은 1년입니다.</li>
          </ol>

          <h2 className="mt-6 text-base font-bold text-slate-900">제7조 (리워드 지급)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제8조 (금지행위)</h2>
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제9조 (서비스 이용 제한)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
            <li>회사는 이용자가 제8조의 금지행위를 한 경우 사전 통보 없이 서비스 이용을 제한할 수 있습니다.</li>
            <li>부정행위가 적발된 경우 해당 참여는 자동 반려되며, 계정이 정지될 수 있습니다.</li>
            <li>부정행위 탐지 점수가 70점 이상인 경우 자동 반려됩니다.</li>
          </ol>

          <h2 className="mt-6 text-base font-bold text-slate-900">제10조 (회원 탈퇴)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
            ...
            <li>광고주 탈퇴 시 미사용 크레딧에 대한 환불은 환불 정책에 따릅니다.</li>
          </ol>

          <h2 className="mt-6 text-base font-bold text-slate-900">제11조 (서비스 변경 및 중단)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제12조 (지적재산권)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제13조 (면책조항)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제14조 (분쟁 해결)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제15조 (사업자 정보)</h2>
          ...
          <h2 className="mt-6 text-base font-bold text-slate-900">제16조 (기타)</h2>
          <ol className="list-decimal pl-5 text-slate-700">
